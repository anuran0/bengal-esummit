...
import linklogo from '../assets/linkdin.png'
export default function Team() {
  ...
  <div class="property-card">
    <a href="/">
      <div class="property-image0">
        <div class="property-image-title">        
        </div>
      </div></a>
    <div class="property-description">
      <h5>Swapneel Chaudhuri</h5>
      <p>Event Head</p>
      <a href=""><img class="linklogo" src={linklogo} alt=""/></a>
    </div>
    <a href="/">
    </a>
  </div>
